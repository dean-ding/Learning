package com.dean.keystore;

import android.os.Build;
import android.security.KeyPairGeneratorSpec;
import android.util.Base64;

import com.dean.MyApplication;
...
/**
 * Created: tvt on 18/1/22 11:22
 */
public class EncryUtils
{
    private static EncryUtils encryUtilsInstance;
        ...
        if (!"".equals(alias))
        {
            try
            {
                ...
                if (!keyStore.containsAlias(alias))
                {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2)
                    {
                        spec = new KeyPairGeneratorSpec.Builder(MyApplication.getApplication())
                                .setAlias(alias)
