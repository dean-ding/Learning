package com.dean.swipbacklayout;
...
import com.dean.R;
import com.dean.swipback.SwipeBackLayout;
import com.dean.swipback.ui.SwipeBackActivity;
import com.orhanobut.logger.Logger;

/**
 * Created: tvt on 17/12/21 09:02
 */
public class TestSwipeBackActivity extends SwipeBackActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mSwipeBackLayout.addSwipeListener(new SwipeBackLayout.SwipeListener()
        {
            ...
            {
                Logger.i("onScrollStateChange");
            }

            @Override
            public void onEdgeTouch(int edgeFlag)
            {
                Logger.i("onEdgeTouch");
    ...
    public void onClick(View v)
    {
        ...
        {
            case R.id.btn_start:
                startActivity(new Intent(TestSwipeBackActivity.this, TestSwipeBackActivity.class));
                break;
