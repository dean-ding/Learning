        ...
        try
        {
            ...
            if (params != null)
            {
                ...
                for (int i = 0; i < params.size(); i++)
                {
                    ...
                    temp.append("content-disposition: form-data; name=\"").append(key).append("\"").append(LINEND + LINEND);
            ...
            temp.append(MP_BOUNDARY).append(LINEND);
            temp.append("content-disposition: form-data; name=\"logfile\"; filename=\"")
