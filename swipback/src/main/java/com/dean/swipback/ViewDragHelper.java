...
public class ViewDragHelper
{
     ...
     * callback's
     * {@link com.dean.swipback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.dean.swipback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.dean.swipback.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.dean.swipback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
